module Android
  class ReceivePaymentFormScreen < Appom::Page
    section :common_screen, CommonScreen, 'id', 'android:id/content'
    element :btn_create_receive_payment, :id, 'tvCreate'
    ...
    def fill_payment_form(payment_details)
      ...
      wait_for { btn_create_receive_payment.displayed? }
      btn_create_receive_payment.click
    end
    ...
    def input_other_info(payment_details)
      ...
      if payment_details['tags'].present?
        ...
        $driver.find_element(:xpath, "//android.widget.TextView[@resource-id='id.jurnal.mobile:id/tv_tags_name'][@text='#{payment_details['tags']}']//following-sibling::android.widget.CheckBox").click
